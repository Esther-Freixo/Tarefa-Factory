...
async function deleteUser(request, reply) {
  const getParamsSchema = import_zod.default.object({
...
async function update(request, reply) {
  const updateParamsSchema = import_zod2.default.object({
    userId: import_zod2.default.string().uuid()
  });
  const updateBodySchema = import_zod2.default.object({
    name: import_zod2.default.string().optional(),
    email: import_zod2.default.string().optional(),
    photo: import_zod2.default.string().optional(),
    password: import_zod2.default.string().optional()
  });
...
async function register(request, reply) {
  const registerBodySchema = import_zod15.default.object({
    name: import_zod15.default.string(),
    email: import_zod15.default.string().email(),
    photo: import_zod15.default.string(),
