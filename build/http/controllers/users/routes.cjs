...
async function create(request, reply) {
  const createBodySchema = import_zod.default.object({
    title: import_zod.default.string(),
    created_at: import_zod.default.string().transform((str) => new Date(str)),
...
async function deletePost(request, reply) {
  const getParamsSchema = import_zod2.default.object({
    postId: import_zod2.default.string().uuid()
  });
...
async function update(request, reply) {
  const updateParamsSchema = import_zod3.default.object({
    postId: import_zod3.default.string().uuid()
  });
  const updateBodySchema = import_zod3.default.object({
    title: import_zod3.default.string().optional(),
    content: import_zod3.default.string().optional()
  });
  const userId = request.user.sub;
...
async function get(request, reply) {
  const getParamsSchema = import_zod4.default.object({
    postId: import_zod4.default.string().uuid()
  });
  const { postId } = getParamsSchema.parse(request.params);
  try {
    const prismapostsRepository = new PrismaPostsRepository();
...
async function getByUserId(request, reply) {
  const getParamsSchema = import_zod5.default.object({
...
function postsRoutes(app2) {
  ...
  app2.get("/posts", getAll);
  app2.get("/posts/:postId", get);
  app2.get("/posts/user/:userId", getByUserId);
  app2.delete("/posts/:postId", { onRequest: [verifyJWT] }, deletePost);
  app2.patch("/posts/:postId", { onRequest: [verifyJWT] }, update);
}
...
async function create2(request, reply) {
  const createBodySchema = import_zod6.default.object({
    ...
    postId: import_zod6.default.string().optional(),
    commentId: import_zod6.default.string().optional()
  }).refine(
...
async function deleteLike(request, reply) {
  const getParamsSchema = import_zod7.default.object({
    likeId: import_zod7.default.string().uuid()
  });
...
async function createComment(request, reply) {
  const schema = import_zod8.default.object({
    content: import_zod8.default.string(),
    postId: import_zod8.default.string().uuid(),
    created_at: import_zod8.default.string().transform((str) => new Date(str))
  });
...
async function updateComment(request, reply) {
  const { commentId } = request.params;
  const userId = request.user.sub;
  const schema = import_zod9.default.object({
    content: import_zod9.default.string()
  });
...
async function register(request, reply) {
  const registerBodySchema = import_zod11.default.object({
    ...
    photo: import_zod11.default.string(),
    password: import_zod11.default.string().min(6)
  });
  const {
    name,
    email,
...
async function deleteUser(request, reply) {
  const getParamsSchema = import_zod12.default.object({
    userId: import_zod12.default.string().uuid()
  });
  const { userId } = getParamsSchema.parse(request.params);
...
async function update2(request, reply) {
  const updateParamsSchema = import_zod13.default.object({
    userId: import_zod13.default.string().uuid()
  });
  const updateBodySchema = import_zod13.default.object({
    name: import_zod13.default.string().optional(),
    email: import_zod13.default.string().optional(),
    photo: import_zod13.default.string().optional(),
    password: import_zod13.default.string().optional()
  });
...
async function get2(request, reply) {
  const getParamsSchema = import_zod14.default.object({
    userId: import_zod14.default.string().uuid()
  });
  const { userId } = getParamsSchema.parse(request.params);
  try {
    const prismaUsersRepository = new PrismaUsersRepository();
...
async function authenticate(request, reply) {
  const authenticateBodySchema = import_zod15.default.object({
    email: import_zod15.default.string().email(),
    password: import_zod15.default.string().min(6)
  });
  const {
    email,
    password
...
function userRoutes(app2) {
  ...
  app2.get("/users", getAll3);
  app2.get("/users/:userId", get2);
  app2.delete("/users/:userId", { onRequest: [verifyJWT] }, deleteUser);
  app2.patch("/users/:userId", { onRequest: [verifyJWT] }, update2);
}
