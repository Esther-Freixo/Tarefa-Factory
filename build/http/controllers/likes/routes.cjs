...
async function createComment(request, reply) {
  const schema = import_zod11.default.object({
    content: import_zod11.default.string(),
    postId: import_zod11.default.string().uuid(),
...
async function create2(request, reply) {
  const createBodySchema = import_zod14.default.object({
    created_at: import_zod14.default.string().transform((str) => new Date(str)),
    postId: import_zod14.default.string().optional(),
    commentId: import_zod14.default.string().optional()
  }).refine(
...
async function deleteLike(request, reply) {
  const getParamsSchema = import_zod15.default.object({
    likeId: import_zod15.default.string().uuid()
  });
