...
var prisma_posts_repository_exports = {};
__export(prisma_posts_repository_exports, {
  PrismaPostsRepository: () => PrismaPostsRepository
});
module.exports = __toCommonJS(prisma_posts_repository_exports);
