...
var prisma_likes_repository_exports = {};
__export(prisma_likes_repository_exports, {
  PrismaLikesRepository: () => PrismaLikesRepository
});
module.exports = __toCommonJS(prisma_likes_repository_exports);
